export default function EvidenceActionModal({ data, close }) {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50 p-4">
      ...
      {/* Modal Card */}
      <div className="bg-slate-800 border border-slate-700 rounded-xl shadow-2xl w-full max-w-md overflow-hidden relative animate-[fadeIn_0.2s_ease-out]">
        ...
        <div className="p-6">
          ...
          <div className="bg-slate-900/50 rounded-lg border border-slate-700/50 p-4 mb-6">
            ...
            <div className="mb-3">
              <span className="text-xs font-bold text-slate-500 uppercase tracking-wider block mb-1">Evidence ID</span>
              <span className="font-mono text-xl text-blue-400 tracking-wide">{data.evidence_code}</span>
            </div>
            
            <div>
              <span className="text-xs font-bold text-slate-500 uppercase tracking-wider block mb-1">Description</span>
          ...
          <div className="space-y-3">
            ...
            <button 
              className="w-full border border-slate-700 bg-slate-800 text-slate-500 font-medium py-3 rounded-lg flex items-center justify-center gap-2 cursor-not-allowed opacity-75 hover:bg-slate-800"
              disabled
            >
