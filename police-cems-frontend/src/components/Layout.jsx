...
export default function Layout({ children }) {
  ...
  function changePassword() {
    if (!window.confirm(
      "You will be redirected to the password change page. Continue?"
    ))
      return;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-blue-900 text-slate-100">
      {/* ================= HEADER ================= */}
      <header className="h-20 flex items-center justify-between px-6 bg-slate-900 border-b border-slate-700 relative">
